...
import ke.gekika.backend.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public void handleClentAbortException(Exception ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleUnauthorisedException(RuntimeException ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleRuntimeException(Exception ex, WebRequest request) {
        logger.error("Runtime exception occoured: {}", ex.getMessage(), ex);
        return buildErrorResponse(ex, HttpStatus.BAD_REQUEST, request);
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<ErrorResponse> handleGeneralException(Exception ex, WebRequest request) {
        logger.error("Unexpected exception occoured: {}", ex.getMessage(), ex);
