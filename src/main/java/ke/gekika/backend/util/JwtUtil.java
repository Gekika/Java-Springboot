package ke.gekika.backend.util;
...
public class JwtUtil {
    ...
    private String createToken(Map<String, Object> claims, String subject, Long accessTokenExpireTime) {
        Date now = new Date();
    ...
    public Date extractExpiration(String token) {
        return extractClaim(token, claims -> claims.get("expiration", Date.class));
    }
